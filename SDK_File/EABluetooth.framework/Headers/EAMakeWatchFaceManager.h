...
/// 1. 2 kinds of digital watch face (black and white numbers)  ==> Type1
/// 2. 6 kinds of pointer watch face (black and white pointer * 3 kinds of scale [no scale, bar scale, digital bar scale]) ==> Type2
/// 3. Default custom digital dial (color needs to be set) ==> Type3
/// 4. Customize the digital dial (need to set the digital color, digital size, digital position)  ==> Type4
/// 5. Customize pointer dial (picture, position and rotation point need to be set) ==> Type5
///
...
/// 1.Type 4 and type 5 is an advanced custom watch face, which needs to be planned by the product manager and designed by a UI designer. If your app doesn't require this, just use type 1 ~ 3.
...
/// 自定义表盘介绍
/// 一、目前有5种自定义表盘风格
/// 1.2种数字表盘（黑白色数字） ==> Type1
/// 2.6种指针表盘（黑白色指针 * 3种刻度【无刻度、线条刻度、数字线条刻度】） ==> Type2
...
///
/// 三、高级自定义表盘
/// 1.Type 4和Type 5是高级自定义表盘，需要产品经理来规划并且需要UI设计师来设计。如果你的应用程序不需要这个，只需使用Type1 ~ 3。
