...
class GetBigDataViewController: UIViewController  , UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func operatingPhone(_ no:NSNotification){
        ...
        case .big8803DataUpdateFinish:
            ...
            /**
             ...
             When the watch sends this notification type [.big8803DataUpdateFinish], it means that the watch big data has been sent. At this time, you can call the SDK method to obtain different types of big data [EABleBigDataManager.default().getBigData()].
            ...
            let sportHrData = EABleSendManager.default().getBigData(withBigDataType: .sportHrData);
            
            // sleep score data
            let sleepScoreData = EABleSendManager.default().getBigData(withBigDataType: .sleepScoreData);
    ...
    func eg_sleepData(_ sleepData : NSArray){
        ...
        // 如何处理睡眠数据
        // 1.调用这个方法获取sleepData “ let sleepData = EABleBigDataManager.default().getBigData(withBigDataType: .sleepData); ”
        ...
        // 1. call this method to get sleepData " let sleepData = EABleBigDataManager.default().getBigData(withBigDataType: .sleepData); "
